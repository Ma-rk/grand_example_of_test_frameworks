...
def step_impl(context):
    ...
    Helper.generate_content_list_from_file = MagicMock(return_value=content_list)
...
def data_provider(context):
    ...
    yield context.content_list
    # cleaning up fixture
    context.content_list = None
